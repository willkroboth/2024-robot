...
public final class Constants {
  ...
  public final static class DrivetrainConstants{
    ...
    public static final double BACK_RIGHT_ENCODER_OFFSET = 0.413-0.25;
    ...
    public static final double FRONT_RIGHT_ENCODER_OFFSET = 0.359-0.25;
    
    public static final int BACK_LEFT_ANGLE_ID = 7;
    public static final int BACK_LEFT_SPEED_ID = 8;
    ...
    public static final double BACK_LEFT_ENCODER_OFFSET = 0.836-0.25;
    ...
    public static final double FRONT_LEFT_ENCODER_OFFSET = 0.653-0.25;
