...
public final class Constants {
  ...
  public final static class DrivetrainConstants{
    ...
    public static final double BACK_RIGHT_ENCODER_OFFSET = 0.836;
    ...
    public static final double BACK_LEFT_ENCODER_OFFSET = 0.653;
    ...
    public static final double FRONT_LEFT_ENCODER_OFFSET = 0.359;
